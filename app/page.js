        ...
        {loading && (
          <div style={s.card}>
            <div style={s.loadingWrap}>
              <div style={s.spinner} />
              <p style={s.loadingText}>抄録を生成しています...</p>
              <p style={s.loadingSubText}>タイトル案・抄録本文を作成中です</p>
            </div>
          </div>
        )}
...
const s = {
  ...
  spinner:     { width: 44, height: 44, border: "3px solid #1e293b", borderTop: "3px solid #06b6d4", borderRadius: "50%", animation: "spin 0.8s linear infinite", margin: "0 auto 20px" },
